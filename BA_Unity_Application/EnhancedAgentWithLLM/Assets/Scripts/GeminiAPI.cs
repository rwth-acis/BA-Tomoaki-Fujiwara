...
public class GeminiAPI : MonoBehaviour {
    ...
    /// <summary>
    /// Define the available callback functions for the LLM.
    /// </summary>
    private void InitializeTools() {
        infoFunctionCallingLists = new Tool[]
        {
            new Tool
            {
                ...
                {
                    // Example Function: getSceneObjectInfo
                    /*
                    new FunctionDeclaration
                    {
                        name = "getSceneObjectInfo",
                        description = "Gets detailed information about a specific object in the 3D scene.",
                        parameters = new Parameters
                        {
                            type = "object", //This could be "string" if you only need a single object name, boolen, or other types as needed
                            properties = new Dictionary<string, Property>
                            {
                                { "objectName", new Property { type = "string", description = "The name of the object to get information about." } }
                            },
                            required = new string[] { "objectName" }
                        }
                    },
                    */
                    // Example Function: setObjectColor
                    new FunctionDeclaration
                    {
                        name = "setObjectColor",
                    ...
                    // Get an object information from scene
                    new FunctionDeclaration
                    {
                    ...
                    new FunctionDeclaration
                    {
                        ...
                        description = "Retrieves a list of all objects present in the scene, along with their names and any available documentation. " +
                        "This function is useful for discovering objects when their exact names are unknown," +
                        " or for getting an overview of the scene's contents." +
                        " You can then use this information to query specific objects with getObjectInformation.",
                        parameters = new Parameters
                        {
                            type = "object"
                        }
                    ...
                    new FunctionDeclaration
                    {
                        name = "setOnKitchenFaucetColdWater",
                        description = "This turn the kitchen faucet cold water handle on. As the result, the cold water comes out from faucet.",
                        parameters = new Parameters
                        {
                            type = "object"
                        }
