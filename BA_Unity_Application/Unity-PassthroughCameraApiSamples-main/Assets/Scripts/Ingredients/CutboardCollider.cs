...
public class CutboardCollider : MonoBehaviour
{
    ...
    public Transform OnionCutBoardCoordinate;

    public Transform CarrotCutBoardCoordinate;
        ...
        if (currentOnBoard == "")
        {
            ...
            if (other.gameObject.name == "OnionUncut")
            {
                ...
                if (parentTransform != null)
                {
                    ...
                    parentTransform.SetParent(OnionCutBoardCoordinate);
                    parentTransform.localPosition = Vector3.zero;
                    parentTransform.localRotation = Quaternion.Euler(0, 0, 0);
            ...
            if (other.gameObject.name == "CarrotUncut")
            {
                ...
                if (parentTransform != null)
                {
                    ...
                    parentTransform.SetParent(CarrotCutBoardCoordinate);
                    parentTransform.localPosition = Vector3.zero;
                    parentTransform.localRotation = Quaternion.Euler(0, 270, 0);
