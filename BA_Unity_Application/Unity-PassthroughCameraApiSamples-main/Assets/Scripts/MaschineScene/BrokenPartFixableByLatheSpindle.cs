...
public class BrokenPartFixableByLatheSpindle : MonoBehaviour
{
    ...
    public bool isLatheSpindlePlace = false;
    ...
    public void LatheSpindleInPlace() { 
        isLatheSpindlePlace=true;
    }

    public void LatheSpindleOutOfPlace() { 
        isLatheSpindlePlace=false;
    }
