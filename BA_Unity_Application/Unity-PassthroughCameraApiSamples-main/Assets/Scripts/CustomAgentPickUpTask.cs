...
namespace i5.VirtualAgents.AgentTasks
{
	...
	/// </summary>
	public class CustomAgentPickUpTask : AgentBaseTask, ISerializable
    {
        /// <summary>
        ...
        public CustomAgentPickUpTask(GameObject pickupObject, SocketId socketId = SocketId.RightHand)
        {
